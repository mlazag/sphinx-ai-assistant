...
(function() {
    ...
    // Create a menu item
    function createMenuItem(id, text, description) {
        ...
        item.innerHTML = `
            <div class="ai-assistant-menu-item-content">
                <div class="ai-assistant-menu-item-title">
                    <img src="${staticPath}/copy-to-clipboard-16.svg" class="ai-assistant-menu-icon" aria-hidden="true" alt="">
                    <span>${text}</span>
                </div>
    ...
    function insertContainer(container, position) {
        if (position === 'sidebar') {
            // For Furo theme, target the RIGHT sidebar (page TOC), not the left one
